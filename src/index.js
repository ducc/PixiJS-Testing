...
function loadSprites() {
    ...
    // hud - score
    score = new PIXI.Text(
        "Score: 0", { font: "32px sans-serif", fill: "black" }
    );
    ...
    position = new PIXI.Text(
        "Position: -1, -1", { font: "32px sans-serif", fill: "black" }
    );
...
function play() {
    ...
    // arena collisions
    var arenaCollide = contain(player, { x: 0, y: 0, height: window.innerHeight, width: window.innerWidth });
